...
public class Fountain : MonoBehaviour {
    ...
    void Start()
    {
        ...
        for (int i = 0; i < particleCount; ++i)
        {
            ...
            particleArray[i].velocity.x = Random.Range(-2f, 2f);
            particleArray[i].velocity.y = 20f;
            particleArray[i].velocity.z = Random.Range(-2f, 2f);

            particleArray[i].startingVelocity = particleArray[i].velocity;

            particleArray[i].lifetime = Random.Range(0f, 5f);
        }
